...
public class Navigation extends ActionBarActivity
        implements NavigationDrawerFragment.NavigationDrawerCallbacks ,BlankFragment.OnFragmentInteractionListener,ObdDataReaderFragment.OnFragmentInteractionListener{
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        if(position ==0){
            ...
            Intent obdIntent = new Intent(this,ObdReaderMainActivity.class);
